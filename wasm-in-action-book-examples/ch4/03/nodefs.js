...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'nodefs.wast';
  var wasmBinaryFile = 'nodefs.wasm';
  var asmjsCodeFile = 'nodefs.temp.asm.js';
...
var ASM_CONSTS = [function() { FS.mkdir('/data'); FS.mount(NODEFS, {root:'.'}, '/data'); }];
