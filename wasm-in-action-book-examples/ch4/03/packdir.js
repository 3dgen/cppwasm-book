...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'packdir.data';
    var REMOTE_PACKAGE_BASE = 'packdir.data';
...
Module['FS_createPath']('/', 'dat_dir', true, true);
Module['FS_createPath']('/dat_dir', 'sub_dir', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_packdir.data');

    };
    Module['addRunDependency']('datafile_packdir.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 25, "filename": "/dat_dir/t1.txt"}, {"start": 25, "audio": 0, "end": 50, "filename": "/dat_dir/t2.txt"}, {"start": 50, "audio": 0, "end": 83, "filename": "/dat_dir/sub_dir/t3.txt"}], "remote_package_size": 83, "package_uuid": "509fb4dd-8e56-45d8-b803-18b12af81d37"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'packdir.wast';
  var wasmBinaryFile = 'packdir.wasm';
  var asmjsCodeFile = 'packdir.temp.asm.js';
