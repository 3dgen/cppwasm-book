...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'packfile.data';
    var REMOTE_PACKAGE_BASE = 'packfile.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_packfile.data');

    };
    Module['addRunDependency']('datafile_packfile.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 19, "filename": "/hello.txt"}], "remote_package_size": 19, "package_uuid": "f9ce04fd-96aa-4541-bfe1-a18c6e75bc1f"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'packfile.wast';
  var wasmBinaryFile = 'packfile.wasm';
  var asmjsCodeFile = 'packfile.temp.asm.js';
