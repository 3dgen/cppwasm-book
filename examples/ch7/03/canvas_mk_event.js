...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'canvas_mk_event.wast';
  var wasmBinaryFile = 'canvas_mk_event.wasm';
  var asmjsCodeFile = 'canvas_mk_event.temp.asm.js';
...
var real__get_img_buf = asm["_get_img_buf"]; asm["_get_img_buf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__get_img_buf.apply(null, arguments);
};
...
var real__on_key_down = asm["_on_key_down"]; asm["_on_key_down"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__on_key_down.apply(null, arguments);
};

var real__on_mouse_move = asm["_on_mouse_move"]; asm["_on_mouse_move"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__on_mouse_move.apply(null, arguments);
};
...
var _get_img_buf = Module["_get_img_buf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_get_img_buf"].apply(null, arguments) };
...
var _on_key_down = Module["_on_key_down"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_on_key_down"].apply(null, arguments) };
var _on_mouse_move = Module["_on_mouse_move"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_on_mouse_move"].apply(null, arguments) };
