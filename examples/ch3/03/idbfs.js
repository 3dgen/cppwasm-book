...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'idbfs.wast';
  var wasmBinaryFile = 'idbfs.wasm';
  var asmjsCodeFile = 'idbfs.temp.asm.js';
...
var ASM_CONSTS = [function() { FS.syncfs(function (err) {}); },
 function() { FS.mkdir('/data'); FS.mount(IDBFS, {}, '/data'); FS.syncfs(true, function (err) { assert(!err); ccall('test', 'v'); }); }];
